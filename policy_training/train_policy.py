...
env = SpotmicroEnv(use_gui=False, reward_fn=reward_function, init_custom_state=init_custom_state, dest_save_file="states/state10M-1.pkl")
...
model.save("policies/ppo_walk10M-1")
env.close()
